...
from SeAFusion.model_TII import BiSeNet
from SeAFusion.TaskFusion_dataset import Fusion_dataset
from SeAFusion.FusionNet import FusionNet
...
def fusion():
    args = Opt()
    n_class = 9
    seg_model_path = './SeAFusion/model/Fusion/model_final.pth'
    fusion_model_path = './SeAFusion/model/Fusion/fusionmodel_final.pth'
    fused_dir = './images/tmp/fusion'
    ...
    ir_path = './images/tmp/ir'
    vi_path = './images/tmp/vi'
